...
gboolean janus_rtcp_has_bye(char *packet, int len, guint32 video_ssrc_peer, guint32 audio_ssrc_peer, gboolean &video_ssrc_peer_bye_received, gboolean &audio_ssrc_peer_bye_received);
